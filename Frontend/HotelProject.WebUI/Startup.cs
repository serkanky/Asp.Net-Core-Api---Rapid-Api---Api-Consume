    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigureApplicationCookie(options =>
            {
                ...
                options.ExpireTimeSpan = TimeSpan.FromHours(1);            //Kullanýcý ne kadar süreden sonra tekrar giriþ yapsýn  //1 Saat sonra tekrar giriþ yapacak.
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseHttpsRedirection();           //OLMAYAN SAYFAYI 404 SAYFAMIZA YÖNLENDÝRME
            app.UseStaticFiles();
